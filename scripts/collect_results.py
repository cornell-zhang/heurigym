...
def main():
    if len(sys.argv) != 3:
        print("Usage: python3 collect_best_results.py <llm_solutions_dir> <dataset_path>")
        sys.exit(1)
    ...
    for run_file in run_files:
        ...
        results = run_optimization(run_file, dataset_path)
