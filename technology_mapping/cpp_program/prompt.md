...
2. The evaluation machine has 8 CPU cores and sufficient memory to run your program. The time limit for this question is 10 seconds. You are free to implement parallel algorithms where appropriate to maximize performance.

3. You should generate a C++ function that can be compiled with g++ 9.4.0.
